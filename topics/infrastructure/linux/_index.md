...
- [File descriptors](file-descriptors.md) - Per-process integer handles for accessing I/O resources
- [Address space layout](address-space-layout.md) - Memory segments of a process: text, data, BSS, heap, and stack
