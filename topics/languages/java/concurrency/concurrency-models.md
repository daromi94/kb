...
**Virtual threads:** Managed by the JVM and multiplexed onto a small carrier
thread pool. They restore sequential programming style while the runtime
handles the multiplexing transparently.
